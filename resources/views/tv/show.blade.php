...
@section('content')
        ...
        <div class="container flex flex-col px-4 py-4 mx-auto md:flex-row">
            ...
            <div class="md:ml-24">
                ...
                <div class="mt-12">
                    ...
                    <h4 class="font-semibold text-white">Created By</h4>
    ...
    <div class="border-b border-gray-800 tv-cast">
        <div class="container px-4 py-16 mx-auto">
            <h2 class="text-4xl font-semibold">TV Cast</h2>
    ...
    <!-- tv images -->
    <div x-data="{isOpen: false, image: ''}" class="border-b border-gray-800 tv-images">
        <div class="container px-4 py-16 mx-auto">
